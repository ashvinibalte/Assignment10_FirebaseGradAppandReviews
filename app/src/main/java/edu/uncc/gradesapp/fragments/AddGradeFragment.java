...
public class AddGradeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedCourse == null) {
                    binding.textViewCourse.setText("Please select Course");
                }else if (selectedLetterGrade == null) {
                    binding.textViewGrade.setText("Please select Grade");
                } else if (selectedSemester == null){
                    binding.textViewSemester.setText("Please select Semetser");
                }else {
